import { IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonItem, IonLabel, IonReorder, IonReorderGroup, ItemReorderEventDetail } from "@ionic/react";
...
const BoardStack: React.FC<StackProps> = ({
    title,
    aiDisabled
}) => {
